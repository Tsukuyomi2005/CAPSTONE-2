...
export function StaffDashboard() {
  ...
  const thisMonthRevenue = getThisMonthCompletedRevenue(appointments);
  const thisMonthRevenueFormatted = `P${thisMonthRevenue.toLocaleString('en-PH', {
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{thisMonthRevenueFormatted}</p>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600 mt-1">{appointmentsThisMonthCount}</p>
            </div>
